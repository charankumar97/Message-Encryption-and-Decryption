...
wn.title("Message Encrypt And Decrypt")
Message = StringVar()
key = StringVar()
mode = IntVar()
Output = StringVar()
...
headingLabel = Label(headingFrame1, text=" Welcome to Message Encryption and Decryption", fg='grey19', font=('Courier',15,'bold'))
...
#Function that executes on clicking Show Message function in python message encryption decryption
def Result():
  msg = Message.get()
  k= key.get()
  i = mode.get()
  if (i==1):
    ...
    messagebox.showinfo('Error', 'Please Choose one of Encryption or Decryption. Try again.')
